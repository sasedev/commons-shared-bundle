 ...
 */
class ExternalJavascript extends Script
{
	 ...
	 */
	public function __construct($src = null, $charset = null, $defer = false, $async = false)
	{
		parent::__construct($src, 'text/javascript', $charset, $defer, $async, null);
	}
}